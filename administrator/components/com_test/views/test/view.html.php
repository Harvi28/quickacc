...
//Joomla! Debug Console
	...
	protected function addToolBar()
	{
		...
		if ($isNew)
		{
			$title = JText::_('COM_TEST_MANAGER_TEST_NEW');
		}
		else
		{
			$title = JText::_('COM_TEST_MANAGER_TEST_EDIT');
		}
	...
	//{
		...
		//$document->setTitle($isNew ? JText::_('COM_TEST_TEST_CREATING') :
          //      JText::_('COM_TEST_TEST_EDITING'));
	//}
}