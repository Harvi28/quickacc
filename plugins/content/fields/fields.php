...
class PlgContentFields extends JPlugin
{
	...
	public function onContentPrepare($context, &$item, &$params, $page = 0)
	{
		...
		//
		//$badwords = array("idiot","asshole");
		//$repl = array("bd");
        //$text = $item->fulltext;

        //for badword in badwords:
        //$main = str_replace($badwords,$repl,$text);
        //print_r($main);
        //echo "<pre>";
        //print_r($text);
        //die("sdf");
		...
		echo "<pre>";
		print_r($item->fulltext);
		die();
		
       //$query = "INSERT INTO test(name, content, tstamp) values (" ","$introtext","CURRENT_TIME()")";
